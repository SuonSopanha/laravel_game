...
<body class="bg-gray-200">
  <div class="game-container border-green-500 max-w-lg mx-auto text-center bg-white rounded-lg shadow-lg border-2 p-8 mt-20">
    ...
    <div id="gameForm">
      <div class="button-container flex justify-center space-x-6 mb-8">
        <button type="button" class="choice bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-3 rounded-full transition duration-300" id="rock" data-choice="rock">
          <span class="text-3xl">✊</span>
          <span class="block text-sm mt-2">Rock</span>
        </button>
        <button type="button" class="choice bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-3 rounded-full transition duration-300" id="paper" data-choice="paper">
          <span class="text-3xl">✋</span>
          <span class="block text-sm mt-2">Paper</span>
        </button>
        <button type="button" class="choice bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-3 rounded-full transition duration-300" id="scissors" data-choice="scissors">
          <span class="text-3xl">✌️</span>
          <span class="block text-sm mt-2">Scissors</span>
        </button>
      </div>
      <div id="playAgainContainer" class="mt-6" style="display: none;">
        <button type="button" id="playAgain" class="bg-purple-600 hover:bg-purple-700 text-white font-bold px-6 py-3 rounded-full transition duration-300">Play Again</button>
      </div>
    </div>
